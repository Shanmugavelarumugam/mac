...
class _AccessoriesScreenState extends State<AccessoriesScreen> {
  List<dynamic> accessoriesProducts = [];
  bool isLoading = true;
  ...
  Future<void> fetchAccessoriesProducts() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to load accessories products');
      }
    } catch (e) {
      print('Error: $e');
      setState(() {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            else if (accessoriesProducts.isEmpty)
              Center(
                child: Text(
              ...
              SizedBox(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    final product = accessoriesProducts[index];
            ...
            // ✅ Newly Added Products filtered by 'Accessories' category
            const NewlyAddedProducts(category: 'Accessories'),
          ],
        ),
      ),
    );
